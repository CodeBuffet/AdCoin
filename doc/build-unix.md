UNIX BUILD NOTES
====================
Some notes on how to build AdCoin in Unix.
...
memory available when compiling AdCoin. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build AdCoin without wallet.
...
# Configure AdCoin to use our own-built instance of BDB
cd $LITECOIN_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard AdCoin distributions and independently built
...
with 4.8-built AdCoin is needed follow the steps under "Berkeley DB" above.
