...
AdCoin is extensively tested on multiple operating systems using
...
AdCoin should also work on most other Unix-like systems but is not
...
AdCoin now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in AdCoin 0.10.4) it has been disabled by default.
...
AdCoin has supported automatically pruning the blockchain since 0.13.2. Pruning
...
When AdCoin is out-of-sync on startup, a semi-transparent information
...
The Alert System was disabled and deprecated in AdCoin 0.10.4 and removed in 0.13.2. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of AdCoin. This was added in conjunction with
